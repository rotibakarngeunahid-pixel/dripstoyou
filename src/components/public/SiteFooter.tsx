...
import { formatWaDisplay, getWaNumber } from '@/lib/whatsapp';
...
export default function SiteFooter({ waNumber }: Props) {
  const displayNumber = waNumber ?? getWaNumber();
  ...
  return (
    <>
      <footer className="footer" id="contact-footer">
        <div className="footer-inner">
          <div className="footer-grid">
            <div id="about-footer">
              ...
              <p className="footer-brand-desc">
                Layanan IV therapy on-call profesional yang hadir langsung ke villa, hotel, atau tempat menginap Anda di Bali.
              </p>
              <a
              ...
              >
                {WA_SVG}
                {formatWaDisplay(displayNumber)}
              </a>
            </div>

            <div>
              <div className="footer-col-title">Treatment</div>
            ...
            <div>
              ...
              <div className="footer-links">
                ...
                <Link href="/legal/terms-conditions">Syarat &amp; Ketentuan</Link>
                <Link href="/legal/privacy-policy">Kebijakan Privasi</Link>
              </div>
            </div>
          ...
          <div className="footer-bottom">
            <p className="footer-copy">© {new Date().getFullYear()} Drips To You - Bali. All rights reserved.</p>
      ...
      <a
        href={`https://wa.me/${displayNumber}?text=${encodeURIComponent('Halo Drips To You - Bali, saya ingin informasi lebih lanjut')}`}
        className="wa-float"
        target="_blank"
        rel="noopener noreferrer"
