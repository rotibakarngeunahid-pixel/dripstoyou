...
import { ArrowLeft, MessageCircle, RefreshCw, Stethoscope, UserPlus, ClipboardCheck, FileSignature, Syringe, Star, Receipt } from 'lucide-react';
      ...
      <div className="grid gap-5 lg:grid-cols-[1.1fr_1fr]">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-5 gap-2">
            ...
            <ClinicalLink href={`/crm/invoice/${b.id}`} icon={Receipt} label="Invoice" done={!!b.treatment?.completed_at} />
          </div>
        </div>
