...
const BK_TEXT: Record<'en' | 'id', BK> = {
  ...
  id: {
    ...
    step1Sub: 'Setiap drip dirancang untuk kebutuhan spesifik Anda',
    step1Next: 'Lanjut ke Jadwal',
    step1Empty: 'Belum ada treatment tersedia. Hubungi kami via WhatsApp untuk booking manual.',
    schedTitle: 'Pilih Jadwal',
    schedSub: 'Waktu tersedia mengikuti jadwal aktif yang sudah diatur tim kami.',
    locTitle: 'Lokasi',
    locSub: 'Kami datang ke lokasi dalam area layanan aktif',
    dateLabel: 'Tanggal *',
    timeLabel: 'Waktu *',
    loadingSlots: ' Memuat…',
    noSlots: 'Belum ada waktu tersedia di tanggal ini. Coba pilih tanggal lain.',
    slotHint: 'Pilih tanggal dulu untuk melihat waktu tersedia.',
    peopleLabel: 'Jumlah Peserta *',
    locTypeLabel: 'Tipe Lokasi *',
    areaLabel: 'Area Layanan *',
    areaDefault: 'Pilih area layanan…',
    areaEmpty: 'Belum ada area layanan aktif. Hubungi kami via WhatsApp.',
    addressLabel: 'Alamat Lengkap *',
    addressPlaceholder: 'Nama villa/hotel, nomor kamar, nama jalan…',
    step3Title: 'Data Diri',
    step3Sub: 'Untuk konfirmasi jadwal dan pengiriman detail treatment',
    ...
    waCaption: '— dalam jam layanan.',
    successTitle: 'Booking Berhasil Dikirim!',
    successSub: 'Tim kami akan segera menghubungi Anda via WhatsApp untuk konfirmasi jadwal.',
    ...
    errNoTreatment: 'Pilih treatment dulu sebelum melanjutkan.',
    errLoad: 'Data gagal dimuat. Coba muat ulang halaman.',
